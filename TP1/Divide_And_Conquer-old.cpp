    ...
    if (inputFileStream) {
        while (std::getline(inputFileStream, line)) {
            if (isFirstLine) {
                ...
                isFirstLine = false;
                int right, left, height; // on doit le faire une fois pour prendre la premiere coordonnée
